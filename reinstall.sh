...
/home/mateusz/Documents/install_moje/shared_python_virtual_environment/bin/python3 -m unittest || true # tests may fail, in such case next line may help us to fix this
