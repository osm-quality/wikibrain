...
class WikidataTests(unittest.TestCase):
    ...
    def test_detecting_psychiatric_prison_as_valid_primary_link(self):
        self.assert_linkability('Q20170666')
    ...
    def test_romanesque_bridge_as_valid_primary_link(self):
        self.assert_linkability('Q10351385')
    ...
    def test_detecting_sport_complex_as_valid_primary_link(self):
        self.assert_linkability('Q42954701')

    def test_detecting_secondary_school_as_valid_primary_link(self):
        self.assert_linkability('Q66623606')
    ...
    def test_lithiu_deposit_as_valid_primary_link(self):
        self.assert_linkability('Q110946361')
    ...
    def test_lake_as_valid_primary_link(self):
        self.assert_linkability('Q18287855')
    ...
    def test_geopark_as_valid_primary_link(self):
        self.assert_linkability('Q679531')
    ...
    def test_protected_area_as_valid_primary_link_testcase_d(self):
        self.assert_linkability('Q3936898')

    def test_onsen_as_valid_primary_link(self):
        self.assert_linkability('Q8000205')

    def test_headquarters_landscape_area_as_valid_primary_link(self):
        self.assert_linkability('Q5578587')

    def test_religious_headquarters_as_valid_primary_link(self):
        self.assert_linkability('Q1802285')
    ...
    def test_mural_as_valid_primary_link_problems_with_individual_items_classified_as_genre(self):
        self.assert_linkability('Q109331485')
        self.assert_linkability('Q110699333')
        self.assert_linkability('Q2410932')
        self.assert_linkability('Q111464711')
        self.assert_linkability('Q3057616')
    ...
    def test_rammed_earth_building_is_construction_as_in_object_not_as_in_economical_activity(self):
        ...
        self.assert_linkability('Q85417373')
        self.assert_linkability('Q124454388')
        self.assert_linkability('Q69525771')
        self.assert_linkability('Q45742076')
        self.assert_linkability('Q124435580')
    ...
    def test_airport_which_duplicated_at_wikimedia_as_valid_primary_link(self):
        self.assert_linkability('Q16895081')

    def test_train_station_which_duplicated_at_wikimedia_as_valid_primary_link(self):
        self.assert_linkability('Q46606019')
    ...
    def test_animal_sculpture_as_valid_primary_link(self):
        ...
        self.assert_linkability('Q121323215')
        self.assert_linkability('Q121363526')
    ...
    def test_boundary_marker_as_valid_primary(self):
        self.assert_linkability('Q41224097')
        self.assert_linkability('Q130639668')
        self.assert_linkability('Q16892695')
        self.assert_linkability('Q49404812')
    ...
    def test_belfry_as_valid_primary_link(self):
        self.assert_linkability('Q30231843')
        self.assert_linkability('Q114877536')

    def test_church_gate_as_valid_primary_link(self):
        self.assert_linkability('Q26570977')

    def test_sacristy_as_valid_primary_link(self):
        self.assert_linkability('Q41138467')

    def test_passion_playhouse_as_valid_primary_link(self):
        self.assert_linkability('Q46837189')

    def test_architectural_element_as_valid_primary_link(self):
        self.assert_linkability('Q55149')
        self.assert_linkability('Q38052803')
        self.assert_linkability('Q1747112')
    ...
    def test_floral_clock_as_valid_primary_link(self):
        self.assert_linkability('Q5460482')

    def test_wall_as_valid_primary_link(self):
        self.assert_linkability('Q98630768')
        self.assert_linkability('Q30559238')

    def test_inn_as_valid_primary_link(self):
        self.assert_linkability('Q49368012')
    ...
    def test_hospital_as_valid_primary_link_testcase_a(self):
    ...
    def test_church_building_as_valid_primary_link_testcase_e(self):
        self.assert_linkability('Q2321547')

    def test_church_building_as_valid_primary_link_testcase_f(self):
        self.assert_linkability('Q3656641')

    def test_church_building_as_valid_primary_link_testcase_g(self):
        self.assert_linkability('Q4240411')

    def test_church_building_as_valid_primary_link_testcase_h(self):
        self.assert_linkability('Q113653915')

    def test_church_building_as_valid_primary_link_testcase_i(self):
        self.assert_linkability('Q12293209')

    def test_church_building_as_valid_primary_link_testcase_j(self):
        self.assert_linkability('Q7589444')

    def test_church_building_as_valid_primary_link_testcase_k(self):
        self.assert_linkability('Q4723487')

    def test_church_building_as_valid_primary_link_testcase_l(self):
        self.assert_linkability('Q98717354')

    def test_church_building_with_fraternity_confusion_as_valid_primary_link(self):
        self.assert_linkability('Q109758320')
        self.assert_linkability('Q109758257')
        self.assert_linkability('Q37894838')
        self.assert_linkability('Q109758387')
        self.assert_linkability('Q37890750')
        self.assert_linkability('Q109758207')
        self.assert_linkability('Q37890839')
    ...
    def test_dam_as_valid_primary_link(self):
        self.assert_linkability('Q92301333')
    ...
    def test_bookstore_as_valid_primary_link(self):
        self.assert_linkability('Q5610145')

    def test_city_as_valid_primary_link(self):
        self.assert_linkability('Q13298')

    def test_city_as_valid_primary_link_testcase_b(self):
        self.assert_linkability('Q29303')
    ...
    def test_glade_as_valid_primary_link(self):
        self.assert_linkability('Q24948147')
    ...
    def test_town_hall_as_valid_primary_link(self):
        self.assert_linkability('Q1747553')
    ...
    def test_office_as_valid_primary_link(self):
        self.assert_linkability('Q1802284')
    ...
    def test_that_european_union_is_not_an_event(self):
        self.is_not_an_event('Q458')
    ...
    def test_school_building_as_valid_primary_link(self):
        self.assert_linkability('Q107339923')
    ...
    def test_that_branded_diet_is_not_a_food_but_is_unlinkable_anyway_testcase_c(self):
        #self.assert_unlinkability('Q84763014') TODO
    ...
    def test_that_engineering_company_is_not_an_event_but_is_unlinkable_anyway_testcase_b(self):
        #self.assert_unlinkability('Q15991800') # TODO - it is not a valid link either
        self.is_not_an_event('Q15991800')
        self.is_not_a_behavior('Q15991800')
    ...
    def test_more_companies_is_not_an_event_or_behavior(self):
        self.is_not_an_event('Q2057096')
        self.is_not_a_behavior('Q2057096')
        # TODO - it is not a valid link either
    ...
    def test_archeological_site_as_valid_primary_link_testcase_d(self):
        self.assert_linkability('Q1154220')
    ...
    def test_warehouse_as_valid_primary_link(self):
        self.assert_linkability('Q104161867')

    def test_apparatus_as_valid_primary_link(self):
        self.assert_linkability('Q316053')

    def test_administrative_building_as_valid_primary_link(self):
        self.assert_linkability('Q47543532')
    ...
    def test_abandoned_settlement_is_linkable(self):
    ...
    def test_settlement_is_linkable_and_is_not_a_mental_process(self):
    ...
    def test_industrial_site_is_valid_link(self):
        self.assert_linkability('Q117006579')
        self.is_not_a_specific_error_class('Q117006579', 'an intentional human activity')
    ...
    def test_organisation_is_not_event(self):
        self.is_not_an_event('Q50038880')
        self.is_not_an_event('Q1515218')
    ...
    def test_ruined_semaphore_tower_as_valid_primary_link(self):
        self.assert_linkability('Q122902688')
    ...
    def test_military_museum_as_valid_primary_link(self):
        self.assert_linkability('Q6974515')
    ...
    def test_former_village_as_valid_primary_link(self):
        self.assert_linkability('Q5191708')
        self.assert_linkability('Q48941240')
    ...
    def test_fish_weir_officialy_recognised_as_heritage_asset_as_valid_primary_link(self):
        self.assert_linkability('Q26207149')

    def test_building_officialy_recognised_as_heritage_asset_as_valid_primary_link(self):
        self.assert_linkability('Q41207914')
